...
For modelers who need all US jurisdictions (not just hub-specific subsets), forecasttools provides location codes derived from Census data via `location_table`:
...
summary_data = [
    ...
    ("ALL_LOCATION_CODES", "All 58 US jurisdiction FIPS codes"),
    ("STATE_LOCATION_CODES", "50 US state FIPS codes"),
    ("TERRITORY_LOCATION_CODES", "DC + 6 territory FIPS codes"),
